...
navigator.setup({
  ...
  lsp = {
    ...
    servers = {"angularls", "gopls", "tsserver", "flow", "bashls", "dockerls", "julials", "pylsp", "pyright",
    ...
    "r_language_server", "rust_analyzer", "terraformls", "svelte", "texlab", "clojure_lsp"}, -- by default empty, but if you whant navigator load  e.g. `cmake` and `ltex` for you , you
